---
title: "5.1_appendix_either tutorial_cohort1"
...
# load anaylsis data for cohort 1
```
...
D <- 50
  ...
  for (i in 1:D) {
    ...
    Data_K1  <- sienaDataCreate(relations_K1, Statistik, WiW, both_tutorials, Female,eithertut) 
...
stargazer(finalResults_rounded_K1, summary = FALSE, title= paste0("Analysis results cohort 1, 1st wave imputed with stationary SAOM ",D,"imputations"),
          rownames = TRUE, type = "html", out = paste0("Results/SAOM_analysis_results_K1_either_",D,"_imputations.html"))

```

```{r}
todaysdate <- format(Sys.Date(),"%y%m%d")
save(list = ls(.GlobalEnv), file = paste0(todaysdate,"_analysis_cohort1_environment_",D,"imp","_either_tutorial.Rdata"))
```
